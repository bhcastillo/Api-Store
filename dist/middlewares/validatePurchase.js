...
exports.validateProducts = exports.validateCustomerId = void 0;
...
exports.validateProducts = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const conn = yield database_1.connect();
    const products = req.body.products;
    for (let product of products) {
        const validateProductId = yield conn.query(`SELECT id FROM products WHERE id = ${product.id}`);
